...
<body>
    ...
    <div class="container my-3">
        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    <td><img src="anh/laravel.png" alt="Laravel Programming" style="width: 100px;"></td>
                ...
                <tr>
                    <td><img src="anh/dot-net.png" alt=".NET Programming" style="width: 100px;"></td>
                    <td>.NET Programming</td>
                    <td>This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</td>
                </tr>
                <tr>
                    <td><img src="anh/spring-boot.png" alt="Spring Boot Programming" style="width: 100px;"></td>
                ...
                <tr>
                    <td><img src="anh/angular.png" alt="Angular Programming" style="width: 100px;"></td>
